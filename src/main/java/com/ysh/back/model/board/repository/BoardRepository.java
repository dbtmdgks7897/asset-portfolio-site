...
public interface BoardRepository extends JpaRepository<BoardEntity, Long> {
       ...
       List<BoardEntity> findByNameContainingOrContentContainingOrUserEntity_NameContainingAndDeletedAtIsNull(
                     String nameSearch, String contentSearch, String userSearch);
       ...
       List<BoardEntity> findAllByUserEntity_IdxOrderByCreatedAtDesc(Long userIdx);

       List<BoardEntity> findByIdxOrNameContainingOrUserEntity_EmailContaining(Long boardIdx, String name, String nickname);
}
